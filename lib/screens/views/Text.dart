...
class _UsersScreenState extends State<UsersScreen> {
  ...
  Future<void> checkIfApiReachable() async {
    try {
      ...
      const url = 'http://192.168.232.7:3000/api';
  ...
  //           centerTitle: true,
  //         ),
  //         body: showList(context, ApiService(Dio(BaseOptions(contentType: 'application/json'))).getUsers()),
  //         // UserListItemWidget(),
  //         floatingActionButton: const MoveToCreateUserComponent(),
  //   );
  //   }else{
  ...
  //         centerTitle: true,
  //       ),
  //       body: showList(context, UserDatabaseHelper.getAllUsers()),
  //       floatingActionButton: const MoveToCreateUserComponent(),
  //     );
  //   }
  // }
